...
# argument.
   ...
   return(list(cover=apply(out,2:3,mean),
      cil=ciendav[,2,]-ciendav[,1,]))
}
...
#' @examples
#' fun.invertsigntest(rnorm(12))
#' @export
#' @importFrom stats qwilcox qbinom
#' @importFrom graphics axis
fun.invertsigntest<-function(dataset,alpha=0.05,maint=NULL,tau=0.5,returndata=FALSE,npts=10000){
